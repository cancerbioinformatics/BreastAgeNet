...
Leveraging pre-trained feature extractors, this step extracts visual features for each WSI based on the `_patch_wsi.csv` file.  For this step, implement the following:
```
